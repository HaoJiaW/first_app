...
public class Test2Fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("TestFragment2-onCreate");
    }
    ...
    public void onStart() {
        super.onStart();
        System.out.println("TestFragment2-onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        System.out.println("TestFragment2-onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        System.out.println("TestFragment2-onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        System.out.println("TestFragment2-onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        System.out.println("TestFragment2-onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        System.out.println("TestFragment2-onDestroy");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        System.out.println("TestFragment2-onDetach");
    }
}